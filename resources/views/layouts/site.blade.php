...
{{--<title>Unique</title>--}}
  ...
  {{--// добавил--}}
{{--<link rel="icon" href="{{assets('asset/css/favicon.png')}}" type="image/png">--}}
...
{{--<link href="{{asset('assets/css/animate.css')}}" rel="stylesheet" type="text/css">--}}
  ...
  {{--<link rel="icon" href="{{asset('assets/css/favicon.png')}}" type="image/png">--}}
  ...
  {{--<!--[if lt IE 9]>--}}
    {{--<jsscript src="{{ asset('assets/js/respond-1.1.0.min.js')}}"></jsscript>--}}
    {{--<jsscript src="{{ asset('assets/js/html5shiv.js')}}"></jsscript>--}}
    {{--<jsscript src="{{ asset('assets/js/html5element.js')}}"></jsscript>--}}
{{--<![endif]-->--}}
...
{{--<footer class="footer_wrapper" id="contact">--}}
  ...
  {{--</div>--}}
  {{--<div class="container">--}}
    {{--<div class="footer_bottom"><span>Original © 2019 <a href="http://webthemez.com"></a></span> </div>--}}
  {{--</div>--}}
{{--</footer>--}}
{{--<!--Hero_Section-->--}}
